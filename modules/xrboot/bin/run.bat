...
if "%run_file%" == "" if exist %srcdrv%\lib\%1.cab set run_file=%srcdrv%\lib\%1.cab
if "%run_file%" == "" if exist %srcdrv%\level1\%1 set run_file=%srcdrv%\level1\%1
if "%run_file%" == "" if exist %srcdrv%\level1\%1.cab set run_file=%srcdrv%\level1\%1.cab
if "%run_file%" == "" if exist %srcdrv%\level2\%1 set run_file=%srcdrv%\level2\%1
if "%run_file%" == "" if exist %srcdrv%\level2\%1.cab set run_file=%srcdrv%\level2\%1.cab
if "%run_file%" == "" if exist %srcdrv%\level3\%1 set run_file=%srcdrv%\level3\%1
if "%run_file%" == "" if exist %srcdrv%\level3\%1.cab set run_file=%srcdrv%\level3\%1.cab
...
for %%i in (*.cab %srcdrv%\lib\*.cab %srcdrv%\level1\*.cab %srcdrv%\level2\*.cab %srcdrv%\level3\*.cab) do echo %%i
goto _end
:_unpack
